...
describe('IngestionService', () => {
  ...
  describe('triggerIngestion', () => {
    it('should successfully trigger document ingestion', async () => {
      const documentId = '1';
      // Return complete AxiosResponse for the post call
      ...
      // Ensuring the second call also returns a proper AxiosResponse
      jest.spyOn(httpService, 'post').mockReturnValueOnce(of(mockAxiosResponse));
  ...
  describe('updateIngestionStatus', () => {
    it('should successfully update ingestion status', async () => {
      ...
      // Cast the result to any since the function's inferred return type is void.
      const result: any = await service.updateIngestionStatus(statusId, updateData.status, null);
